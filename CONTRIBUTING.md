...
1. **Fork the Repository** – Click the fork button on GitHub and clone your fork locally:
   ...
   ```sh
   git clone https://github.com/weastur/maf.git
   cd maf
   ```
...
If you find bugs or have feature requests, please [open an issue](https://github.com/weastur/maf/issues) with relevant details.
